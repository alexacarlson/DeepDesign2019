    ...
    def download(self,arguments):
        ...
        if arguments['single_image'] is None and arguments['url'] is None and arguments['similar_images'] is None and \
            ...
            print('-------------------------------\n'
                  ...
                  '-------------------------------')
            sys.exit()
        arguments['chromedriver']='/home/alexandracarlson/Desktop/Robotics_Building_networks/Visualising-Image-Classification-Models-and-Saliency-Maps/chromedriver'
